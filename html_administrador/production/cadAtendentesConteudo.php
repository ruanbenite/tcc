...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form  method="POST" action="selAtendentes.php" class="form-horizontal form-label-left input_mask">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="dtnascimento" name="dtnascimento" placeholder="Data de Nascimento" required="required" autocomplete="off" data-inputmask="'mask': '99/99/9999'">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="celular" name="celular" placeholder="Telefone Celular" required="required" autocomplete="off" data-inputmask="'mask': '(99)99999-9999'">
                    <span class="fa fa-mobile form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="fixo" name="fixo" placeholder="Telefone Fixo" autocomplete="off" data-inputmask="'mask': '(99)9999-9999'">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="cep" name="cep" placeholder="CEP" autocomplete="off" data-inputmask="'mask': '99.999-999'">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="cpf" name="cpf" placeholder="CPF" required="required" autocomplete="off" data-inputmask="'mask': '999.999.999-99'">
                    <span class="fa fa-newspaper-o  form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="rg" name="rg" placeholder="RG" required="required" autocomplete="off" data-inputmask="'mask': '99.999.999-9'">
                    <span class="fa fa-newspaper-o form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="dtcontratacao" name="dtcontratacao" placeholder="Data de contratação" required="required" autocomplete="off" data-inputmask="'mask': '99/99/9999'">
                    <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>
                </div>
